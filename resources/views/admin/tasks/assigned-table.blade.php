<div class="table-responsive">
    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        @foreach ($task->assignedlawyers as $key => $lawyer)
            <!--begin::Table row-->
            <tr>
                <!--begin::User=-->
                <td class="">
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            ...
                            <a href="{{ route('admin.tasks.complete', [$task->id]) }}"  onclick="event.preventDefault();
                                    document.getElementById('complete-form').submit();" class="menu-link px-3">&nbsp;&nbsp;  إنهاء المهمة</a>
                            <form id="complete-form" action="{{ route('admin.tasks.complete', [$task->id]) }}" method="POST" class="d-none">
                                @csrf
                            </form>
                            @endif
                        </div>
