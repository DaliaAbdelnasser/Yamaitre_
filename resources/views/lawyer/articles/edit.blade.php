                                            ...
                                            <div class="row">
                                                ...
                                                <div class="careerfy-blog careerfy-blog-grid">
                                                    <div class="row">
                                                        ...
                                                        {!! Form::model($article ,['route' => ['lawyer.articles.update', $article->id], 'method' => 'patch', 'files' => true]) !!}
                                                            ...
                                                            <div class="upload__box">
                                                                ...
                                                                <div class="upload__img-wrap">
                                                                    @if($article->articles_images->first() != null)
                                                                        <div class="row">
                                                                            @foreach ($article->articles_images as $images)
                                                                            <div class="col-md-4">
                                                                            <!-- <div class="d-flex flex-center flex-shrink-0 bg-light rounded w-200px h-200px w-lg-150px h-lg-150px me-7 mb-4"""> -->
                                                                                <img src="{{ asset('uploads/' . $images->image) }}"  class="img-fluid bg-light rounded" style="max-height: 200px; object-fit: cover;" alt="Article Image">
                                                                            <!-- </div> -->
                                                                            </div>
                                                                            @endforeach
                                                                        </div>
                                                            ...
                                                            <div class="error">{{ $message }}</div>
                                                            @enderror
                                                            <button class="careerfy-static-btn careerfy-bgcolor m-t-20 m-b-20">حفظ</button>
