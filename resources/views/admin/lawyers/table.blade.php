        ...
        <tr>
            ...
            <td class="d-flex align-items-center">
                ...
                <div class="d-flex flex-column">
                    <a href="{{ route('admin.lawyers.show', $user->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $user->first_name ?? ''}}</a>
                </div>
            </td>
            <!--end::User=-->
            <!--begin::Role=-->
			...
			<td>
				<div class="badge badge-light fw-bolder">
					{{ ($user->userable->status == true ) ? 'نشط' : 'غير نشط'}}
				</div>
			</td>
            <!--begin::Action=-->
            <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                	...
                	<!--end::Menu item-->
					@if ($user->userable->status == false )
						<!--begin::Menu item-->
						<div class="menu-item px-3">
                            {!! Form::open(['route' => ['admin.lawyers.activate', $user->id], 'method' => 'post']) !!}
                            {!! Form::button('تفعيل', ['type' => 'submit', 'class' => 'btn btn-ghost']) !!}
                            {!! Form::close() !!}
						</div>
						<!--end::Menu item-->
					@endif
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <div class="swal2-html-container my-15" id="" style="display: block;">هل انت متأكد من حذف هذا المحامي؟</div>
                                <div class="swal2-actions" style="display: flex;">
                                    <div class="swal2-loader"></div>
                                    {!! Form::model($user, ['route' => ['admin.lawyers.destroy', $user->id], 'method' => 'delete']) !!}
...
@include('partials._pagination', ['records' => $lawyers])
