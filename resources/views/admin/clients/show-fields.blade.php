			...
			<div class="card-body">
				...
				<div class="d-flex flex-center flex-column py-5">
					...
					<div class="symbol symbol-100px symbol-circle mb-7">
						<img src="{{ asset('uploads/' . $client->userable->profile_image) }}" alt="image" />
					</div>
					<!--end::Avatar-->
					<!--begin::Name-->
					<a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">{{ $client->first_name }} {{ $client->last_name }}</a>
					<!--end::Name-->
					<!--begin::Position-->
					<div class="mb-9">
						<!--begin::Badge-->
						<div class="badge badge-lg badge-light-primary d-inline">موكل</div>
						<!--begin::Badge-->
					</div>
					<!--end::Position-->
				</div>
				...
				<div id="kt_user_view_details" class="collapse show">
					<div class="pb-5 fs-6">
						...
						<div class="text-gray-600">{{ $client->userable->governorates ?? '' }}</div>
						
						<div class="fw-bolder mt-5">التقييم</div>
						<div class="row">
						@php $rating = $client->userable->rate; @endphp  
